...
allCompliments = ["You’re that “Nothing” when people ask me what I’m thinking about.",
...
"Captain Friendly"]
allChuckJokes = ["Chuck Norris uses ribbed condoms inside out, so he gets the pleasure.",
...
async def on_message(message):
    ...
    if ':repost' in message.content.lower():
        await message.channel.send("https://cdn.discordapp.com/attachments/476837202886918145/524680451944742922/general.png")
    if ':mayberepost' in message.content.lower():
        await message.channel.send("https://cdn.discordapp.com/attachments/476837202886918145/562665008253632533/2xkhn3.png")
    ...
    if 'chuck norris' in message.content.lower():
        if not message.author.bot:
            await message.channel.send("Did someone say Chuck Norris? Did you know: " + chuckNorris())
    if ':randomcompliment' in message.content.lower():
        await message.channel.send(random.choice(message.channel.members).mention + " " + compliment())
